...
```{r}
knitr::include_url("arithmetic_and_data_types.html")
```
...
```{r}
knitr::include_url("one_stream_wrangle.html")
```
...
```{r}
knitr::include_url("booleans.html")
```
...
```{r}
knitr::include_url("summarize.html", height = )
```
...
```{r}
knitr::include_url("long_to_wide_and_back.html", height = "400px")
```
...
```{r}
knitr::include_url("joining_data.html")
```
...
```{r}
knitr::include_url("data.table.html")
```
...
```{r}
knitr::include_url("logical_indexing.html")
```
