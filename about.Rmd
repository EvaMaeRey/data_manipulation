...
*Click on the slides below. Then use `->` or `<-` arrow keys to navigate, or [view in new window](arithmetic_and_data_types.html){target="_blank"}*

```{r}
knitr::include_url("arithmetic_and_data_types.html", height =  "420px")
```
...
*Click on the slides below. Then use `->` or `<-` arrow keys to navigate, or [view in new window](one_stream_wrangle.html){target="_blank"}*

```{r}
knitr::include_url("one_stream_wrangle.html", height =  "420px")
```
...
*Click on the slides below. Then `->` or `<-` arrow keys to navigate, or [view in new window](booleans.html){target="_blank"}*

```{r}
knitr::include_url("booleans.html", height =  "420px")
```
...
*Click on the slides below and use arrow keys to advance, or [view in new window](summarize.html#3){target="_blank"}*

```{r}
knitr::include_url("summarize.html", height =  "420px")
```
...
*Click on the slides below. Then use `->` or `<-` arrow keys to navigate, or [view in new window](long_to_wide_and_back.html){target="_blank"}*

```{r}
knitr::include_url("long_to_wide_and_back.html", height = "420px")
```
...
*Click on the slides below and use arrow keys to advance, or [view in new window](joining_data.html){target="_blank"}*

```{r}
knitr::include_url("joining_data.html", height =  "420px")
```
...
*Click on the slides below and use arrow keys to advance, or [view in new window](data.table.html){target="_blank"}*

```{r}
knitr::include_url("data.table.html", height =  "420px")
```
...
*Click on the slides below and use arrow keys to advance, or [view in new window](logical_indexing.html){target="_blank"}*

```{r}
knitr::include_url("logical_indexing.html", height =  "420px")
```
...
- [glue, paste, paste0, cat](glue.html){target="_blank"}

# Formatting tables

- [gt: grammar of tables](gt.html){target="_blank"}
