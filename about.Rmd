...
**values**: numeric,    character,    integer,   date, logical,   factor 

**operators**: `+ `  `-`   `/`   `()` `^ `   

**structures**: scalar, vector, matrix, data frame (with rows and columns)
...
# [Real-Life Data Cleaning Examples](https://evamaerey.github.io/data_manipulation/data_cleaning/data_cleaning){target="_blank"}
