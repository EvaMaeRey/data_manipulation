...
## [Arithmetic operations and data types and structures](arithmetic_and_data_types.html){target="_blank"}

**data types**: numeric,    character,    integer,   date, logical,   factor 
...
# [Manipulation with data.table (under construction)](data.table.html){target="_blank"}


{data.table} is another popular data manipulation package. 

# [Manipulation with base R and logical indexing](logical_indexing.html){target="_blank"}

You can also do a lot of data manipulation without using external packages.

# [Data Cleaning Examples & intro to string manipulation, country identifiers, and data manipulation](https://evamaerey.github.io/data_manipulation/data_cleaning/data_cleaning){target="_blank"}
