...
`r chunk_reveal("read_in_fisheries")`
...
`r chunk_reveal("clean_wikipedia_fisheries")`
...
holidays_2019 %>% 
  ...
  mutate(var_1 = 
           tolower(holiday)) %>% 
  mutate(var_1 = 
           str_replace(holiday, "u", "REPLACED")) #ROTATE
           str_replace(holiday, "^.", "REPLACED")) #ROTATE
           str_replace(holiday, ".$", "REPLACED")) #ROTATE
           str_count(holiday, "a")) #ROTATE
           str_extract(holiday, ".....Day")) #ROTATE
           str_extract(holiday, "[[:PUNCT:]]")) #ROTATE
```



`r chunk_reveal("stringr", break_type = "rotate")`
